export const generatedPostContents: Record<string, string> = {
  "trump-bilim-insanlari-inceleme": `# Trump yönetimi incelemede, Kongre bilgi peşinde; ölümler ve kayıplar UFO iddialarını yeniden alevlendirdi
...
## Soru artık daha büyük: Tesadüf mü, susturma mı?
...
## Kongre devrede: Resmi kurumlara bilgi talebi gönderildi
...
## Trump cephesinden dikkat çeken yaklaşım
...
## Sessizlik, şüpheyi dağıtmak yerine büyütüyor
...
## Sonuç: Cevaplardan çok sorular konuşuluyor
...
Yazan: Avukat Ceren Sumer Cilli`,
  "is-kanunu-degisiklik-taslagi": `# İş Kanunu Değişiklik Taslağı Kamuoyuna Sunuldu: Çalışma Hayatında Yeni Bir Dönem
...
## İş Kanunu Değişiklik Taslağının Genel Gerekçeleri ve Temel Hedefleri
...
## Fazla Mesai Uygulamalarına Yönelik Köklü Değişiklikler
...
### Fazla Mesai Tanımı ve Yıllık Sınırın Korunması
...
### Fazla Mesai Ücreti ve İspat Yükümlülüğüne Yeni Bakış
...
## Uzaktan Çalışma ve Esnek İstihdam Modellerinde Yeni Bir Dönem
...
### Uzaktan Çalışmanın Kapsamı ve Hukuki Zemini
...
### İşveren ve İşçi Yükümlülüklerinde Netleşme
...
### Uzaktan Çalışmada Yargıtay Perspektifi
...
## Diğer Öne Çıkan Düzenlemeler ve Etkileri
...
### Bildirim Usullerinde Elektronik Dönem
...
### 2026 Yılı Asgari Ücret Desteği
...
## Taslağın Türk İş Hukuku ve Çalışma Hayatına Etkileri
...
## Sonuç: Geleceğin Çalışma Hayatına Adaptasyon
...
Yazan: Avukat Ceren Sumer Cilli`,
  "kvkk-ceza-uygulamalari-2026": `# KVKK Ceza Uygulamalarında 2026 İlk Çeyrek Verileri: Kurul Kararları ve Yargıtay İçtihatları Işığında
...
Yazan: Avukat Ceren Sumer Cilli`,
  "iscilik-alacagi-davasi-nasil-acilir": `# İşçilik Alacağı Davası Nasıl Açılır? Adım Adım Rehber
...
1.  **Mahkemenin Adı:** Yetkili İş Mahkemesi belirtilmelidir.
2.  **Davacı ve Davalı Bilgileri:** İşçi (davacı) ve işveren (davalı) ile vekillerinin (varsa) ad, soyadı, TC kimlik numarası/vergi kimlik numarası ve adres bilgileri eksiksiz yazılmalıdır.
3.  **Konu:** Dava konusu olan işçilik alacakları (kıdem, ihbar, fazla mesai vb.) ve talebin özeti açıkça belirtilmelidir. "Fazlaya ilişkin haklarımız saklı kalmak kaydıyla" ibaresinin kullanılması önemlidir.
4.  **Açıklamalar (Olaylar):** İş ilişkisinin başlangıcı, bitişi, çalışma koşulları, ücret miktarı, iş sözleşmesinin fesih şekli ve nedeni gibi olaylar kronolojik ve detaylı bir şekilde anlatılmalıdır. Ödenmeyen alacak kalemleri ve bu alacakların nasıl doğduğuna ilişkin hukuki gerekçeler belirtilmelidir. Örneğin, haksız fesih nedeniyle kıdem ve ihbar tazminatı talep edildiği belirtilebilir.
5.  **Deliller:** Talepleri destekleyen tüm deliller (işyeri ve sigorta kayıtları, ücret bordroları, banka kayıtları, tanık beyanları, bilirkişi incelemesi, yemin vb.) belirtilmelidir. İşçilik alacakları davalarında ispat yükü genellikle işçidedir, ancak bazı durumlarda işverene geçebilir. Bu nedenle delillerin eksiksiz sunulması hayati önem taşır.
6.  **Hukuki Nedenler:** Dayanılan kanun maddeleri (İş Kanunu, Borçlar Kanunu, HMK vb.) belirtilmelidir.
7.  **Sonuç ve Talep:** Talep edilen alacak kalemleri, miktarları ve bunlara uygulanacak faiz türü ve başlangıç tarihleri açıkça yazılmalıdır. Yargılama giderleri ve vekalet ücretinin karşı tarafa yükletilmesi de talep edilmelidir.
8.  **Tarih ve İmza:** Dilekçe tarihi ve davacı veya vekilinin imzası bulunmalıdır.
...
1.  **Dava Dilekçesi ve Cevap Dilekçesi Teatisi:** Taraflar dava ve cevap dilekçelerini sunar. Cevap dilekçesinde zamanaşımı itirazı gibi def'ilerin ileri sürülmesi önemlidir.
2.  **Ön İnceleme Duruşması:** Mahkeme, dava şartlarının ve ilk itirazların incelenmesi, uyuşmazlık konularının tespiti için ön inceleme duruşması yapar.
3.  **Tahkikat (Delillerin Toplanması):** Tarafların sunduğu deliller toplanır, tanıklar dinlenir, bilirkişi raporları alınır. Yargıtay kararlarında, bilirkişi raporlarının hükme esas alınırken çelişkili veya eksik hususlarının giderilmesi gerektiği vurgulanmaktadır.
...
Yazan: Avukat Ceren Sumer Cilli`,
  "tutuklamaya-itiraz-sureci": `# Tutuklamaya İtiraz Süreci: Haklar ve Süreler
...
Yazan: Avukat Ceren Sumer Cilli`,
  "kvkk-ihlali-bildirimi-rehberi": `# KVKK İhlal Bildirimi Rehberi: 2026 Güncel Mevzuat ve Uygulamalar Işığında
...
*   Belirlenen sürelerin geçmesine rağmen verileri sistem içinde yok etmekle yükümlü olanların görevlerini yerine getirmemesi halinde 1 yıldan 2 yıla kadar hapis cezası verilir.
Bu suçların bir tüzel kişi bünyesinde işlenmesi halinde, tüzel kişi hakkında güvenlik tedbirleri (faaliyet izninin iptali veya müsadere gibi) uygulanabilmektedir.
...
Yazan: Avukat Ceren Sumer Cilli`,
  "ifade-ozgurlugu-karar-analizi": `# İfade Özgürlüğü Karar Analizi: Ölçülülük Testi
...
Yazan: Avukat Ceren Sumer Cilli`,
  "uzaktan-calisma-sozlesmeleri-analizi": `# Uzaktan Çalışma Sözleşmelerinde Güncel Riskler
...
Yazan: Avukat Ceren Sumer Cilli`,
  "acik-riza-metni-yeterlilik-analizi": `## Açık Rıza Metinlerinde Yeterlilik Sorunu
